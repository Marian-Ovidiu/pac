...
@section('content')
<section class="py-10 bg-white sm:py-12 lg:py-12">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center mb-6">
            <h1 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Diario di bordo</h1>
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Aggiornamenti dal campo: il nostro viaggio per un’Africa più giusta</p>
        </div>
