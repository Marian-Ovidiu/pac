...
<?php $__env->startSection('content'); ?>
    <section class="relative py-10 overflow-hidden bg-black sm:py-16 lg:py-24 xl:py-32">
        <div class="absolute inset-0">
            <img class="object-cover w-full h-full md:object-left md:scale-150 md:origin-top-left" src="<?php echo e($progetto->immagine_hero['url']); ?>" alt="" />
        </div>
    ...
    <section class="container bg-white flex-column lg:flex lg:flex-row mx-auto">
        <div class="container px-6 mx-auto">
            <?php $__env->startComponent('components.section', ['titolo' => $progetto->problemi_titolo_1, 'items' => [
                [
        ...
        <div class="container px-6 mx-auto">
            <?php $__env->startComponent('components.section', ['titolo' => $progetto->soluzioni_titolo_1, 'items' => [
                           [
...
<?php echo $__env->make('layouts.mainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/editweb2/Sites/01progetti-test/pac/wp-content/themes/my_structure/resources/views/single-progetto.blade.php ENDPATH**/ ?>