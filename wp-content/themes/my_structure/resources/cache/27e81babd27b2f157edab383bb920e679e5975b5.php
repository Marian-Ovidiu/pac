                            ...
                            <div class="grid gap-4 text-left" @submit.prevent>
                                ...
                                <div>
                                    <input x-model="formData.name" @blur="touched.name = true" type="text"
                                        autocomplete="given-name" required placeholder="<?php echo e(load_static_strings('Nome')); ?>"
                                ...
                                <div>
                                    <input x-model="formData.email" @blur="touched.email = true" type="email"
                                        autocomplete="email" required placeholder="<?php echo e(load_static_strings('Email')); ?>"
                                ...
                                <div>
                                    <input x-model="formData.phone" @blur="touched.phone = true" type="tel"
                                        autocomplete="tel" required placeholder="<?php echo e(load_static_strings('Telefono')); ?>"
