        ...
        <nav x-show="open" @click.away="open = false"
            ...
            <div class="flow-root">
                <div class="flex flex-col px-6 -my-2 space-y-1">
                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($item->url); ?>" title="" class="justify-center inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> <?php echo e($item->title); ?> </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
