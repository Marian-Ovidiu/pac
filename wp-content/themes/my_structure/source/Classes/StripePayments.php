...
class StripePayments
{
    ...
    public static function completePayment()
    {
        ...
        $validationError = DonationValidator::validateDonorData($donorData);
        ...
        $paymentValidationError = DonationValidator::validatePaymentIntent($paymentIntent, $expectedAmountCents, $progettoId);
